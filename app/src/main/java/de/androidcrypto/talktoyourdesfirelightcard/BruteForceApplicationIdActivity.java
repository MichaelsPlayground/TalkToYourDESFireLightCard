...
public class BruteForceApplicationIdActivity extends AppCompatActivity implements NfcAdapter.ReaderCallback {

    private static final String TAG = BruteForceApplicationIdActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brute_force_application_id);

        Toolbar myToolbar = (Toolbar) findViewById(R.id.main_toolbar);
        setSupportActionBar(myToolbar);

        output = findViewById(R.id.etBruteForceApplicationIdOutput);
        outputLayout = findViewById(R.id.etBruteForceApplicationIdOutputLayout);
        moreInformation = findViewById(R.id.btnBruteForceApplicationIdMoreInformation);
        rbDoNothing = findViewById(R.id.rbBruteForceApplicationIdDoNothing);
        rbChangeAppKeysToChanged = findViewById(R.id.rbBruteForceApplicationIdAppKeysToChanged);
        rbChangeAppKeysToDefault = findViewById(R.id.rbBruteForceApplicationIdAppKeysToDefault);
        rbChangeMasterAppKeyToChanged = findViewById(R.id.rbBruteForceApplicationIdMasterAppKeyToChanged);
        rbChangeMasterAppKeyToDefault = findViewById(R.id.rbBruteForceApplicationIdMasterAppKeyToDefault);
        rbChangeMasterAppKeyDesToAesDefault = findViewById(R.id.rbBruteForceApplicationIdDesMasterAppKeyToAesDefault);
        ...
        moreInformation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showDialog(BruteForceApplicationIdActivity.this, getResources().getString(R.string.more_information_personalize));
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mGoToHome.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(BruteForceApplicationIdActivity.this, MainActivity.class);
